...
export type BotName =
  ...
  | "Corvid"
  | "Riverfolk"
  | "Legion" //BETA Clockwork 3 (Found on BGG Better Bot Project)
  | "Chameleandroid" //Fan-Made Clockworks
  | "CircuitBoardGoats";
...
export abstract class Bot {
  ...
  public difficultyDescriptions: { [key in Difficulty]: string } = {
    Easy: "",
    Normal: "",
    Challenging: "",
    Nightmare: "",
