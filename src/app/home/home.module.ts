...
import { ChameleandroidComponent } from "../chameleandroid/chameleandroid.component";
import { CircuitBoardGoatsComponent } from "../circuit-board-goats/circuit-board-goats.component";
...
@NgModule({
  ...
  declarations: [
    ...
    ParagraphComponent,
    MarquiseComponent, // Clockwork 1
    EyrieComponent,
    WoodlandComponent,
    VagabondComponent,
    MarquiseDCComponent,
    EyrieDCComponent, // Directors Cut
    WoodlandDCComponent,
    VagabondDCComponent,
    DuchyComponent, // Clockwork 2
    CorvidComponent,
    LizardComponent,
    RiverfolkComponent,
    LegionComponent, // Beta Clockworks
    ChameleandroidComponent, // Fan Clockworks
    CircuitBoardGoatsComponent,
    FormatPipe,
  ],
})
